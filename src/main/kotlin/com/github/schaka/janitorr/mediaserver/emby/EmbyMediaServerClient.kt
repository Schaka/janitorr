...
import com.github.schaka.janitorr.mediaserver.emby.library.PathWrapper
...
interface EmbyMediaServerClient : MediaServerClient {
    ...
    @RequestLine("POST /Library/VirtualFolders/Paths?refreshLibrary=false&reqformat=json")
    ...
    fun validatePath(path: PathWrapper)
}